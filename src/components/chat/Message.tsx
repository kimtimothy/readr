...
import { ExtenededMessages } from '@/types/message';
import { Icons } from '../Icons';
import ReactMarkdown from 'react-markdown';
import { format } from 'date-fns';

interface MessageProps {
  message: ExtenededMessages;
  isNextMessageFromSameUser: boolean;
}

const Message = ({ message, isNextMessageFromSameUser }: MessageProps) => {
  return (
    <div
    ...
    >
      <div
        className={cn(
          'relative h-6 w-6 flex aspect-square items-center justify-center',
          {
